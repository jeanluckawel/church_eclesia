...
<head>
    ...
    <meta name="title" content="Eglesia" />
    <meta name="author" content="Eglesia" />

    <meta
        name="description"
        content="Eglesia est une plateforme de gestion d'église permettant de gérer les membres, les cultes, les événements, les groupes et les activités spirituelles."
    />

    <meta
        name="keywords"
        content="eglesia, église, gestion d'église, membres, fidèles, culte, événements religieux, groupes d'église, communauté chrétienne, administration d'église, tableau de bord église"
    />
...
{{--                />--}}
                <!--end::Brand Image-->
                <!--begin::Brand Text-->
                <span class="brand-text fw-light">Eglecia</span>
                <!--end::Brand Text-->
...
{{--        </div>--}}
    ...
    <footer class="app-footer">
        ...
        <strong>
            Copyright &copy; 2026&nbsp;
            <a href="https://adminlte.io" class="text-decoration-none">Congo Consulting</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
    </footer>
